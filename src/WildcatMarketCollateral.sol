...
//         require(
//             _after <= _before,
//             "After amount must be less than or equal to before amount"
//         );
...
//         require(
//             block.timestamp >= nextLiquidationTrigger,
//             "Liquidator in cooldown!"
//         );
...
//         if (!success) {
//             revert BebopPMMQuoteFailed(data);
//         }
...
//         underlyingMarket.repayAndProcessUnpaidWithdrawalBatches(
//             0,
